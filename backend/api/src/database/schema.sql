-- ============================================
-- Threat Modeling Platform Database Schema
-- SQLite with UUID primary keys and encryption
-- ============================================
...
CREATE TABLE IF NOT EXISTS threat_models (
    ...
    cloud_providers TEXT, -- JSON array of cloud providers
    system_description TEXT,
    data_flow_diagram TEXT, -- JSON representation of DFD
...
CREATE TABLE IF NOT EXISTS analyses (
    ...
    dfd_json TEXT, -- JSON representation of Data Flow Diagram
...
CREATE TABLE IF NOT EXISTS threats (
    id TEXT PRIMARY KEY,
    threat_model_id TEXT NOT NULL,
    threat_rule_id TEXT, -- Reference to predefined threat rules/patterns
...
CREATE TABLE IF NOT EXISTS audit_logs (
    ...
    resource_id TEXT,
    changes_json TEXT, -- JSON object containing before/after values
    details TEXT,
    ip_address TEXT,
    user_agent TEXT,
